...
const OrderSelection = ({ nextStep, prevStep, updateOrder }) => {
  return (
    <View>
      <NavigationBar title="Order" prevStep={prevStep} />
      <View style={{ margin: 10 }}>
        <Text style={{ fontWeight: 'bold', fontSize: 18, textAlign: 'center', marginTop: 15, marginBottom: 10, }}>Recently ordered</Text>
        ...
        <Text style={{ fontWeight: 'bold', fontSize: 18, marginTop: 40, marginBottom: 10, textAlign: 'center' }}>Best sellers</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: 15 }}>
          <TouchableOpacity
            onPress={() => setDirectOrder({
              cereal: 'YoBar Muesli',
